...
suite('test', function () {
    ...
    testWithFixture('fails on failing test and bails by default.', ['test', 'with-failing-unit-test'], async (fixture) => {
    ...
    testWithFixture('fails on failing test but runs all tests if --no-bail is given.', ['test', 'with-failing-unit-test'], async (fixture) => {
    ...
    testWithFixture(`ignores tests in the 'shared' directory.`, ['test', 'with-tests-in-shared'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('runs pre and post scripts and passes them the right parameters.', ['test', 'with-pre-and-post-scripts'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('runs all tests types.', ['with-valid-typescript'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('runs pre and post tasks.', ['test', 'with-pretest-and-posttest-task'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('runs tsx tests.', ['test', 'with-tsx-tests'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('skips test execution if no test directory exists.', ['empty-project'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('loads .env files and applies their content to tests.', ['test', 'with-.env-file'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('loads mocharc.js configuration files and applies them to tests.', ['test', 'with-mocharc-js-configuration-file'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('loads mocharc.json configuration files and applies them to tests.', ['test', 'with-mocharc-json-configuration-file'], async (fixture) => {
        const roboterResult = await runCommand('npx roboter test', {
            cwd: fixture.absoluteTestDirectory,
            silent: true
        });
    ...
    testWithFixture('can selectively run tests using the --grep flag and skips test types without matches.', ['with-valid-typescript'], async (fixture) => {
    ...
    testWithFixture('supports watch mode', ['test', 'with-library-under-test'], async (fixture) => {
        const childProcess = shell.exec('npx roboter test --watch', {
            cwd: fixture.absoluteTestDirectory,
            silent: true,
            async: true
        });
        ...
        await fs.promises.writeFile(path.join(fixture.absoluteTestDirectory, 'lib', 'lib.js'), 'const number = 7;\n\nmodule.exports = number;', 'utf-8');
        await waitForStringInStream({
    ...
    testWithFixture('watch mode runs all relevant pre and post scripts with correct parameters.', ['test', 'with-pre-and-post-scripts'], async (fixture) => {
        const childProcess = shell.exec('npx roboter test --watch --no-bail', {
            cwd: fixture.absoluteTestDirectory,
            silent: true,
            async: true
        });
        let stdoutAccumulator = '';
        const accumulateStdout = (chunk) => {
        ...
        await fs.promises.writeFile(path.join(fixture.absoluteTestDirectory, 'test', 'unit', 'unitTests.js'), stripIndent `
          'use strict'
