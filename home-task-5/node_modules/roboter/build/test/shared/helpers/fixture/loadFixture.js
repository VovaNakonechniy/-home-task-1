...
import { defekt, error, value } from 'defekt';
...
const timer = {
    ...
    lap(message) {
        ...
        buntstift.verbose(`${message} - ${JSON.stringify({ elapsedSinceLast: newTime - this.lastTime, elapsedSinceStart: newTime - this.startTime })}`);
