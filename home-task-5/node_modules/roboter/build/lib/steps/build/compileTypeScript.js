...
const compileTypeScript = async function ({ applicationRoot, noEmit }) {
    ...
    const inputFiles = await globby(tsconfig.include ?? [], {
        absolute: false,
        cwd: applicationRoot,
        ignore: [
            ...tsconfig.exclude ?? [],
    ...
    const compilerOptions = ts.convertCompilerOptionsFromJson(tsconfig.compilerOptions, applicationRoot, tsconfigPath).options;
